...
int main()
{
	...
	cout << "--------------------------------------------------" << endl;
	cout << "|Subject Teacher ->> Gaurav Kumar Nigam <<-- |\n"
		 << endl;
	cout << ">>>----Project Implemented By-----<<<" << endl;
	cout << "Anshuman Tyagi (9920103063)" << endl;
	cout << "Sahil Kapoor  (9920103065)" << endl;
	cout << "Abhyuday Dwivedi  (9920103072)" << endl;
	cout << "Ramansh Sapra   (9920103088)" << endl
		 << endl;
	system("pause");
	system("cls");
	system("color Fc");
